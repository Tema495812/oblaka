...
const zones = [
  ...
  },
  {
    ...
    description: "Коллекция культовых японских автомобилей — Nissan Skyline GT-R, Toyota Supra, Honda. Редкие экземпляры, история JDM культуры и атмосфера настоящего японского гаража.",
