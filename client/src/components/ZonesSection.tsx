...
const zones = [
  {
    ...
    features: ["Обучение с нуля", "Закрытая площадка", "Опытные инструкторы"],
    image: MOTO_IMG,
    accent: "#FF4500",
  },
  {
  ...
  },
  {
    ...
    icon: "🚖",
    title: "Таксопарк",
    subtitle: "Рабочая инфраструктура",
    description: "Профессиональная база для таксопарков. Обслуживание автомобилей, логистика, диспетчеризация. Всё необходимое для эффективной работы автобизнеса.",
    features: ["Обслуживание авто", "Логистика", "Диспетчеризация"],
    image: TAXI_IMG,
    accent: "#F39C12",
  },
  {
