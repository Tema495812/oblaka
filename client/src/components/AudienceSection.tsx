...
const audiences = [
  {
    icon: "🚗",
    title: "Фанаты скорости",
    desc: "Место, где можно прокачать автомобиль и мотоцикл,а так же прокачать навыки и пообщаться с единомышленниками",
    accent: "#FF4500",
  },
  {
    icon: "🔰",
  ...
  },
  {
    ...
    desc: "Уникальная площадка для проведения автошоу, выставок, мотовыступлений, корпоративов и тематических ивентов",
    accent: "#F39C12",
  },
  {
    icon: "📸",
    ...
    <section id="audience" ref={ref} className="relative py-24 md:py-32 bg-[#080808] overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Montserrat', sans-serif" }}
        >
          Автомототранспортный комплекс создан для всех, кто живёт автомобильной культурой — независимо от уровня и цели
        </motion.p>
