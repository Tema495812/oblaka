        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              Уникальный мультиформатный авто-мото комплекс площадью 17.000 м², объединяющий обучение, развлечения и автомобильную и мото инфраструктуру в одном пространстве.
            </motion.p>
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              Расположенный на −3 уровне ТЦ «Облака» у метро Домодедовская, комплекс создан для тех, кто живёт авто-мото культурой — от новичков до профессионалов.
            </motion.p>
